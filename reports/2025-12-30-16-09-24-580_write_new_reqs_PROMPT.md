# Write New Reqs [PROMPT]
**Timestamp:** 2025-12-30-16-09-24-580
**Requirement:** N/A
...
- Review all files already present in `./tmp/new-reqs/` (these are templates/seeds from `./the-system/prompts/`)
