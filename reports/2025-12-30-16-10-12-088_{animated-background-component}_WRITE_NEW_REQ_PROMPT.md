# Write New Req [PROMPT]
**Timestamp:** 2025-12-30-16-10-12-088
...
- **Stub document:** tmp/new-reqs/animated-background-component.md

Read `./the-system/PHILOSOPHY.md` for context on how we approach software and documentation.
...
Identify within the context specified by tmp/new-reqs/animated-background-component.md, reasonably testable behaviors **of delivered software:** anchored in README.md or ./specs/ only.
